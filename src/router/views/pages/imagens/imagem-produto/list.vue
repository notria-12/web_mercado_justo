...
export default {
  ...
  computed: {
    importConfig () {
      return {
        ...
        generalInstructions: [
          ...
          'o nome do arquivo deve ser o código de barrasdo produto.',
    ...
    preSetSearch () {
      return [
        { field: 'categoria', term: 'produto', strict: true }
      ]
    },
    editableFields() {
      return [
        { key: 'codigo_barras', type: 'string', placeholder: 'Código de Barras' },
      ]
    }
  },
  methods: {
